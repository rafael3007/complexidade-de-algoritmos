...
public abstract class Cases {
    ...
    /**
     * In the best case, the chosen number will be in the vector and will be in the initial positions of the Array
     * @return
     */
    public abstract boolean detectarMelhorCaso();

    /**
     * In the middle case, the chosen number will be in the vector but an anywhere position
     * @return
     */
